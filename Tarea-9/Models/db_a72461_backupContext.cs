...
{
    public partial class db_a72461_backupContext : DbContext
    {
        public db_a72461_backupContext()
        {
        }

        public db_a72461_backupContext(DbContextOptions<db_a72461_backupContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=mysql5044.site4now.net;uid=a72461_backup;pwd=grupon00;database=db_a72461_backup", x => x.ServerVersion("8.0.21-mysql"));
            }
        }
